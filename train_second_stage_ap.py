...
# 1. Select target for the training
# 2. Specify model that is used
# 3. Select the train and valid set
# 4. Define the task that is trained
...
from model.one_model.one_stage_models import ResNet18OneStage
...
train_dataset = CheXpertDataset(
    csv_file="./data/splitted/clean_AP_train_new.csv",
    root_dir="../image_data/",
    targets=targets,
    transform=transform,
)
val_dataset = CheXpertDataset(
    csv_file="./data/splitted/clean_AP_valid.csv",
    root_dir="../image_data/",
    targets=targets,
