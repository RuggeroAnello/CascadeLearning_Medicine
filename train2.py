...
# Things that change based on the model choice:
...
if model_type == "one_stage_baseline" or model_type == "two_stage_second_ap" or model_type == "two_stage_second_pa":
    targets = {
    # "sex": 1,
    # "age": 2,
    # "frontal/lateral": 3,
...
if model_type == "one_stage_baseline":
    train_csv_file_path = "Personalized_ML/data/splitted/train.csv"
    val_csv_file_path = "Personalized_ML/data/splitted/valid.csv"
elif model_type == "two_stage_first":
    train_csv_file_path = "Personalized_ML/data/splitted/train.csv"
    val_csv_file_path = "Personalized_ML/data/splitted/valid.csv"
elif model_type == "two_stage_second_ap":
    train_csv_file_path = "Personalized_ML/data/splitted/ap_train.csv"
    val_csv_file_path = "Personalized_ML/data/splitted/ap_valid.csv"
elif model_type == "two_stage_second_pa":
    train_csv_file_path = "Personalized_ML/data/splitted/pa_train.csv"
    val_csv_file_path = "Personalized_ML/data/splitted/pa_valid.csv"
else:
    raise ValueError("Invalid model type specified.")
