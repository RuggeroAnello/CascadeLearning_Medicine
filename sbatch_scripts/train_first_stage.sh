...
#SBATCH --output=/vol/miltank/projects/practical_WS2425/cascade_learning/slurm_out/first_pred_ap-pa-%A.out  # Standard output of the script (%A adds the job id)
#SBATCH --error=/vol/miltank/projects/practical_WS2425/cascade_learning/slurm_out/first_pred_ap-pa-%A.err  # Standard error of the script (%A adds the job id)
...
python train_new.py --config_path train_configs/config_two_stage_first.json
