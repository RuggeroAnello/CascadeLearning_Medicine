...
#SBATCH --output=/vol/miltank/projects/practical_WS2425/cascade_learning/slurm_out/frontal_lateral_split/fr_lat_split-%A.out  # Standard output of the script (%A adds the job id)
#SBATCH --error=/vol/miltank/projects/practical_WS2425/cascade_learning/slurm_out/frontal_lateral_split/fr_lat_split-%A.err  # Standard error of the script (%A adds the job id)
