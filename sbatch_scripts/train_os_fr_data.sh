...
#SBATCH --job-name=os_fr-data
#SBATCH --output=/vol/miltank/projects/practical_WS2425/cascade_learning/slurm_out/os_fr_data/os_fr-data-%A.out  # Standard output of the script (%A adds the job id)
#SBATCH --error=/vol/miltank/projects/practical_WS2425/cascade_learning/slurm_out/os_fr_data/os_fr-data-%A.err  # Standard error of the script (%A adds the job id)
