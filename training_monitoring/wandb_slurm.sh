...
#SBATCH --job-name=wandb_integration  # Job name
#SBATCH --output=/vol/aimspace/projects/practical_WS2425/cascade_learning/slurm_out/wandb_integration-%A.out  # Standard output of the script (Can be absolute or relative path). %A adds the job id to the file name so you can launch the same script multiple times and get different logging files
#SBATCH --error=/vol/aimspace/projects/practical_WS2425/cascade_learning/slurm_out/wandb_integration-%A.err  # Standard error of the script
